...
public class MainActivity extends AppCompatActivity  {
    ...
    private void toLoginActivity() {
        Intent intent = new Intent(this, com.example.tugas15.LoginActivity.class);
        startActivity(intent);
        finish();
    }

    private void toHistorySessionActivity() {
        Intent intent = new Intent(this, com.example.tugas15.HistorySessionActivity.class);
        startActivity(intent);
        finish();
    }
    private void toHistoryLocationActivity() {
        Intent intent = new Intent(this, com.example.tugas15.HistoryLocationActivity.class);
        startActivity(intent);
        finish();
    }
